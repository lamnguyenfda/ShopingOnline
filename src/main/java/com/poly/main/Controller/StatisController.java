...
public class StatisController {
	...
	public String favorite(Model model, @RequestParam("keyword13") Optional<String> name,
	...
	public String order(Model model, @RequestParam("keyword14") Optional<String> name,
			@RequestParam("p") Optional<Integer> p) {
		String findName;
		if (sessionService.get("keyword13") == null) {
			findName = name.orElse("");
