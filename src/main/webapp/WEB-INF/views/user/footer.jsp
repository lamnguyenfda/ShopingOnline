...
<body>
	...
	<div class="container-fluid bg-dark text-secondary mt-5 pt-5">
		<div class="row px-xl-5 pt-5" style="    margin-top: -64px;
    margin-bottom: -34px;">
			<div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
				<h5 class="text-secondary text-uppercase mb-4">Thông tin liên hệ</h5>
				<p class="mb-2">
					<i class="fa fa-map-marker-alt text-primary mr-3"></i>21 W. 46th St., New York, United States
				</p>
				<p class="mb-2">
					<i class="fa fa-map-marker-alt text-primary mr-3"></i>10 Columbus Cir., 4th fl, New York, USA
				</p>
				<p class="mb-2">
					<i class="fa fa-map-marker-alt text-primary mr-3"></i>237 Madison Ave., New York, United States
				</p>
				<p class="mb-2">
					<i class="fa fa-envelope text-primary mr-3"></i>poly@fpt.edu.vn
				</p>
				<p class="mb-0">
					<i class="fa fa-phone-alt text-primary mr-3"></i>0376671757
				</p>
			</div>
		...
		<div class="row border-top mx-xl-5 py-4"
			...
			<div class="col-md-6 px-xl-0" style="margin-bottom: -33px;
    margin-left: 470px;">
				<p class="mb-md-0 text-center text-md-left text-secondary" style="margin-top: 0px;">
					&copy; <a class="text-primary" href="#">Copyright</a>. All Rights
					Reserved. Designed by <a class="text-primary">TeamCode</a>
				</p>
			</div>
