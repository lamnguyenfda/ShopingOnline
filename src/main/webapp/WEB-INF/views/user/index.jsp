...
<body>
	...
	<!-- Categories Start -->
	<div class="container-fluid pt-5" style="margin-top: -63px;">
		<h2
...
<%--						<a href="" class="btn btn-primary">Mua ngay</a>--%>
	...
	<!-- Featured Start -->
	<div class="container-fluid pt-5" style="    margin-top: -62px;">
		<div class="row px-xl-5 pb-3">
	...
	<!-- Products Start -->
	<div class="container-fluid pt-5 pb-3" style="margin-top: -60px;">
		<h2
			class="section-title position-relative text-uppercase mx-xl-5 mb-4">
    ...
    text-align: center;
    margin-bottom: 66px;">THƯƠNG HIỆU</h1>
		<div class="row px-xl-5">
