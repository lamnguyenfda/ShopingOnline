					...
					<form>
						<div
							...
							<input type="checkbox" class="custom-control-input" checked
								...
								for="color-all">Tất cả</label> <span
					...
					<div class="col-12">
						<nav>
							<ul class="pagination justify-content-center">
								<li class="page-item ${(shop.number==0)?'disabled':''}">
									<a class="page-link" href="/shop/category/${sessionScope.cateId}?p=${shop.number-1}">Trước
										</a></li>
