...
<body>
	...
	<ul
		...
		<a class="sidebar-brand d-flex align-items-center justify-content-center" href="/index">
			...
			<div class="sidebar-brand-text mx-3">Bis Store</div>
		</a>
			...
			<div id="collapseProduct" class="collapse"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					...
					<a class="collapse-item" href="/admin/productForm/form">Thêm
						...
						Sách Sản Phẩm</a> <a class="collapse-item" href="/admin/productcateForm/form">Danh
						Mục Sản Phẩm</a><a class="collapse-item" href="/admin/productsizeForm/form">Kích
						Thước Sản Phẩm</a> <a class="collapse-item" href="/admin/productcolorForm/form">Màu
						Sắc Sản Phẩm</a>
				</div>
			</div></li>
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			<div id="collapseManu" class="collapse"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					...
					<a class="collapse-item" href="/admin/manuForm/form">Thêm
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			<div id="collapseCate" class="collapse"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					...
					<a class="collapse-item" href="/admin/categoryForm/form">Thêm
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			<div id="collapseUser" class="collapse"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					...
					<a class="collapse-item" href="/admin/userForm/form">Thêm Người
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			<div id="collapseOrder" class="collapse"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					...
					<a class="collapse-item" href="/admin/order/wait">Đơn Hàng Đang Chờ</a> <a
						class="collapse-item" href="/admin/order/send">Đơn Hàng Đã Giao</a>
				</div>
			</div></li>
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			aria-expanded="true" aria-controls="collapseUtilities"> <i
				class="fas fa-circle-notch"></i> <span>Quản lý Size & Màu sắc</span>
		</a>
			<div id="collapseSize" class="collapse"
				aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
				<div class="bg-white py-2 collapse-inner rounded">
					<h6 class="collapse-header">Quản lý size</h6>
					<a class="collapse-item" href="/admin/sizeForm/form">Thêm mới Size</a>
					<h6 class="collapse-header">Quản lý màu sắc</h6>
					<a class="collapse-item" href="/admin/colorForm/form">Thêm mới màu sắc</a>
				</div>
			</div></li>
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			<div id="collapseStatisFavorite" class="collapse"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					...
					<a class="collapse-item" href="/admin/statis/favorite">Sản Phẩm Yêu Thích</a>
